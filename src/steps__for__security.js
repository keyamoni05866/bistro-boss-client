 ...
 * use AdminRoute that will check whether the user is admin or not if not admin then redirect to any other page . uou could logout user and send them to the login page as well.
 * 
 * ------------
 * TO SEND DATA
 * -----------
